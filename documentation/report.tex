...
\subsubsection{Issues with phase compensation}
...
\begin{itemize}
    ...
    \item Pump intensity radius: W\_PUMP = 1 mm
    ...
    \item Fiber coupling efficiency: ETA\_FIBER\_COUPLING = 0.8
...
mention detectors being positioned optimally because of crystal turning making no difference?, generate readme, conclusions


computation beam not focused; focusing pump increases coincidences instead of decreasing - wrong model need finite-etendue collection model beyond scope of project and that's why beam radius 1mm
