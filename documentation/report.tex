...
The results show a 25-fold improvement in the coincidence counts, with a CHSH statistic of $S = 2.360 \pm 0.036$, proving the presence of strong entanglement inside the photon pairs.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{l c c r}
    ...
    \midrule
    $\ket{HH}$ & $0^\circ$  & $0^\circ$  & 816 \\
    $\ket{HV}$ & $0^\circ$  & $90^\circ$ &  78 \\
    $\ket{VH}$ & $90^\circ$ & $0^\circ$  &  68 \\
    $\ket{VV}$ & $90^\circ$ & $90^\circ$ & 963 \\
    \midrule
    $\ket{++}$ & $45^\circ$  & $45^\circ$  & 912 \\
    $\ket{+-}$ & $45^\circ$  & $135^\circ$ &  93 \\
    $\ket{-+}$ & $135^\circ$ & $45^\circ$  &  75 \\
    $\ket{--}$ & $135^\circ$ & $135^\circ$ & 878 \\
    \bottomrule
  \end{tabular}
...
Finally, the CHSH measurement can be performed again with $\alpha = 0^\circ$, $\alpha' = 45^\circ$ on polariser 2 and $\beta = 22.5^\circ$, $\beta' = 67.5^\circ$ on polariser 1 and using equations \eqref{CHSH}, \eqref{CHSH_correlation}, \eqref{CHSH_std_deviation}, \eqref{CHSH_correlation_std_deviation}. The results are shown in Table \ref{tab:chsh}, where $C$ denotes the coincidence counts of a single setting and $N$ the sum over the four settings belonging to one correlation coefficient. The final result is $S = 2.360 \pm 0.036$, a $9.9 \sigma$ violation of Bell's inequality.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{l c l c r r c}
    ...
    \midrule
    $\alpha$       & $0^\circ$  & $\beta$       & $22.5^\circ$  & 593
      & \multirow{4}{*}{1869} & \multirow{4}{*}{$\phantom{-}0.456 \pm 0.021$} \\
    $\alpha$       & $0^\circ$  & $\beta_\perp$ & $112.5^\circ$ & 240 & & \\
    $\alpha_\perp$ & $90^\circ$ & $\beta$       & $22.5^\circ$  & 268 & & \\
    $\alpha_\perp$ & $90^\circ$ & $\beta_\perp$ & $112.5^\circ$ & 768 & & \\
    \midrule
    $\alpha'$       & $45^\circ$  & $\beta$       & $22.5^\circ$  & 826
      & \multirow{4}{*}{1982} & \multirow{4}{*}{$\phantom{-}0.692 \pm 0.016$} \\
    $\alpha'$       & $45^\circ$  & $\beta_\perp$ & $112.5^\circ$ & 169 & & \\
    $\alpha'_\perp$ & $135^\circ$ & $\beta$       & $22.5^\circ$  & 136 & & \\
    $\alpha'_\perp$ & $135^\circ$ & $\beta_\perp$ & $112.5^\circ$ & 851 & & \\
    \midrule
    $\alpha$       & $0^\circ$  & $\beta'$       & $67.5^\circ$  & 132
      & \multirow{4}{*}{1899} & \multirow{4}{*}{$-0.727 \pm 0.016$} \\
    $\alpha$       & $0^\circ$  & $\beta'_\perp$ & $157.5^\circ$ & 716 & & \\
    $\alpha_\perp$ & $90^\circ$ & $\beta'$       & $67.5^\circ$  & 924 & & \\
    $\alpha_\perp$ & $90^\circ$ & $\beta'_\perp$ & $157.5^\circ$ & 127 & & \\
    \midrule
    $\alpha'$       & $45^\circ$  & $\beta'$       & $67.5^\circ$  & 786
      & \multirow{4}{*}{1970} & \multirow{4}{*}{$\phantom{-}0.484 \pm 0.020$} \\
    $\alpha'$       & $45^\circ$  & $\beta'_\perp$ & $157.5^\circ$ & 227 & & \\
    $\alpha'_\perp$ & $135^\circ$ & $\beta'$       & $67.5^\circ$  & 281 & & \\
    $\alpha'_\perp$ & $135^\circ$ & $\beta'_\perp$ & $157.5^\circ$ & 676 & & \\
    \midrule
    \multicolumn{6}{r}{$S = E(\alpha,\beta) + E(\alpha',\beta)
                            - E(\alpha,\beta') + E(\alpha',\beta')$}
      & $\phantom{-}2.360 \pm 0.036$ \\
    \bottomrule
  \end{tabular}
...
explain improvisation, measurements in pm basis etc - maybe actually try the real fix in the lab; maybe try the other polarizers, small angle calibration issue??




magnetic mounts, half wave plate theory, pics of setup, calculation, theory chsh angles for maximum violation, broad peaks for phase matching measured in practice, dichroic film polarizers?, sigma violation theory
